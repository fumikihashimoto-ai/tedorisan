  ...
  return (
    <div className="my-8 flex justify-center">
      ...
      <div className="hidden md:flex gap-4 justify-center">
        {/* 広告1 */}
        <div>
          <a href="https://px.a8.net/svt/ejp?a8mat=4AVF01+4EDBOY+3Y6M+BXQOH" target="_blank" rel="nofollow noopener noreferrer">
        ...
        {/* 広告2 */}
        <div>
          <a href="https://px.a8.net/svt/ejp?a8mat=4AVF01+4TULF6+5B0Y+HVNAP" target="_blank" rel="nofollow noopener noreferrer">
