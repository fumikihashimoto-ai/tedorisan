...
export default function TablesArticle() {
  return (
    <article className="pb-20 font-['Noto_Sans_JP']">
      <ArticleBodySection id="section-1" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        <ArticleSectionHeading>1. 現代人の悩み 年代別 手取りの現状と未来</ArticleSectionHeading>
        ...
        <ArticleSubHeading>1.1 手取り額が注目される現代社会の背景</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading>1.2 年代別手取りの現状と一般的な傾向</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleTable
          headers={['年代', '手取り額の一般的な傾向', '主な経済的課題・悩み']}
          data={[
            ['20代(新社会人・若手)', '比較的低い、上昇傾向', '生活費、貯蓄、自己投資、奨学金返済'],
            ['30代(子育て・キャリア形成期)', '上昇傾向にあるが、支出も増加', '結婚、出産、育児、住宅購入、教育費の準備'],
            ['40代(働き盛り・管理職)', 'ピークに近づくが、高額支出も多い', '住宅ローン、教育費(大学進学など)、親の介護'],
            ['50代以降(老後準備期)', 'ピークを過ぎ、役職定年などで減少も', '老後資金、健康維持費、セカンドキャリア'],
          ]}
          headerAlign="left"
          dataAlign="left"
        ...
        <ArticleSubHeading>1.3 手取り額の未来予測と経済的課題</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
      ...
      <ArticleBodySection id="section-2" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        <ArticleSectionHeading>2. 手取りの基本を再確認 控除されるものとその仕組み</ArticleSectionHeading>
        <ArticleParagraph className="mb-4">
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse my-5 font-['Noto_Sans_JP'] text-[14px] leading-[25px] min-w-[500px]">
            <thead>
              <tr>
        ...
        <p className="font-['Noto_Sans_JP'] text-[12px] leading-[25px] text-gray-500 mb-4">
