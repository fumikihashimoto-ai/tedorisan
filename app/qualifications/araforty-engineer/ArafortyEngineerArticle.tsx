...
export default function ArafortyEngineerArticle() {
  // 無料個別相談会CTA用（ディープロ）
  const deepro = affiliateServices.find((service) => service.id === 'deepro');
  ...
  return (
    <article className="pb-20">
      ...
      <div className="mb-6 space-y-4">
        ...
        <PointHeaderBox title="編集部コメント" bodyVariant="highlight">
        ...
        <ul className="list-none pl-0 mb-4 space-y-2 font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
          <li>✓ 今の仕事に将来性を感じない</li>
          <li>✓ 「このままでいいのか」と不安</li>
          <li>✓ でも「今更エンジニアは無理かも」と諦めかけている</li>
        </ul>
        ...
        <ul className="list-none pl-0 mb-4 space-y-2 font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
          <li>✅ アラフォー未経験でもエンジニアになれる理由がわかる</li>
          <li>✅ 最短ルートの学習方法がわかる</li>
          <li>✅ 実際の成功事例から具体的なイメージが湧く</li>
          <li>✅ 転職活動で失敗しない方法がわかる</li>
        </ul>
      ...
      <ArticleBodySection id="section-1" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        <ArticleSectionHeading>1. はじめに アラフォー未経験からのエンジニア転職は遅すぎない</ArticleSectionHeading>
        <p className="text-[14px] text-[var(--color-v2-text)] mb-2">
        ...
        <ArticleSubHeading>1.1 エンジニア需要の高まりと年齢の壁</ArticleSubHeading>
        <ArticleParagraph>
        ...
        <ArticleSubHeading>1.2 この記事でわかること</ArticleSubHeading>
        <ArticleParagraph>
      ...
      <ArticleBodySection id="section-2" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        ...
        <ArticleTable
          headers={['活かせるスキルカテゴリ', '具体的な内容とエンジニア職での適用例']}
          data={[
            ['コミュニケーション能力', 'プロジェクトはチームで進められることがほとんどです。顧客からの要件ヒアリング、チームメンバーとの仕様調整、開発進捗の報告など、円滑なコミュニケーションは開発の成否を左右します。過去の職務で培った傾聴力、説明力、交渉力は、エンジニアとして多方面で役立ちます。'],
            ['問題解決能力', 'エンジニアの仕事は、バグの特定と修正、システムの最適化、顧客の課題に対する技術的な解決策の提案など、常に問題解決の連続です。これまでの業務で培った論理的思考力や、課題を構造的に捉え、解決策を導き出す経験は、プログラミングにおけるデバッグや設計、システム改善に直結します。'],
            ['プロジェクト・タスク管理能力', '開発プロジェクトには納期があり、複数のタスクを並行して進める必要があります。自身の業務を計画し、優先順位をつけ、期日までに完遂する能力は、エンジニアとして開発スケジュールを遵守し、品質を保つ上で非常に重要です。マネジメント経験がある場合は、チームリーダーやプロジェクトマネージャーへのキャリアパスも視野に入ります。'],
            ['ビジネス理解力・顧客視点', 'エンジニアは、単に技術を適用するだけでなく、それがどのようなビジネス課題を解決し、どのような価値を生み出すのかを理解する必要があります。営業、企画、経理など、どのような職種であっても、顧客や事業の視点を持って業務に取り組んだ経験は、より実用的で効果的なシステムやサービス開発に貢献します。'],
            ['学習意欲・自己成長力', 'IT業界の技術進化は非常に速く、エンジニアは常に新しい知識やスキルを学び続ける必要があります。アラフォーで新たな分野に挑戦する強い学習意欲と、これまでのキャリアで培ってきた自己成長への意識は、変化の激しいエンジニアの世界で長く活躍するための土台となります。'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
      ...
      <ArticleBodySection id="section-3" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]">LinuxなどのOSに関する知識</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]">ネットワーク（TCP/IP、ルーティングなど）の基礎知識</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]">サーバー構築・運用スキル</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]">データベースの基礎知識</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]">クラウドサービス（AWS、Azure、GCP）の利用経験</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]">セキュリティに関する知識</li>
        </ul>
        <ArticleParagraph>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]">プログラミング言語：Python（主要）、R</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]">機械学習ライブラリ：scikit-learn、TensorFlow、PyTorchなど</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]">データ分析ツール：Jupyter Notebook、Pandas、NumPyなど</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]">統計学、線形代数などの数学的基礎知識</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]">ビジネス課題を解決するための論理的思考力</li>
        </ul>
        <ArticleParagraph>
      ...
      <ArticleBodySection id="section-4" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        ...
        <PointHeaderBox title="よくある質問" bodyVariant="highlight">
          <div className="space-y-3">
            <p className="text-sm text-[var(--color-v2-text)]">「プログラミング、何から勉強すればいいかわからない」</p>
            <p className="text-sm text-[var(--color-v2-text)]">これ、最も多い疑問です。</p>
            <p className="text-sm text-[var(--color-v2-text)]">結論から言うと: <strong>まずはPythonかJavaScriptから始めてください</strong></p>
            <p className="text-sm text-[var(--color-v2-text)]">理由は3つ:</p>
            <ol className="list-decimal pl-6 space-y-1 font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
              <li>学習教材が豊富</li>
              <li>未経験OKの求人が多い</li>
              <li>将来の選択肢が広い</li>
            </ol>
            <p className="text-sm text-[var(--color-v2-text)]">「難しそう...」と思いましたか?</p>
            <p className="text-sm text-[var(--color-v2-text)]">安心してください。40代の方でも、1日1-2時間の学習で3-6ヶ月あれば基礎は身につきます。</p>
          </div>
        </PointHeaderBox>
        ...
        <div className="my-5 space-y-5">
          <div className="border border-gray-200 rounded-lg overflow-hidden">
            <div className="bg-gray-50 px-4 py-2 border-b border-gray-200">
              <p className="font-['Noto_Sans_JP'] font-bold text-[14px] text-gray-800">Python</p>
              <p className="font-['Noto_Sans_JP'] text-[14px] text-gray-600 font-medium">学習難易度：比較的易しい</p>
            </div>
            <div className="px-4 py-4 space-y-3 text-base leading-[1.8]">
              <div>
                <p className="font-['Noto_Sans_JP'] text-[14px] font-semibold text-gray-600 mb-1">特徴</p>
                <p className="font-['Noto_Sans_JP'] text-[14px] text-gray-700">文法がシンプルで読み書きしやすく、初心者でも習得しやすい言語です。豊富なライブラリがあり、様々な分野で活用されています。</p>
              </div>
              <div>
                <p className="font-['Noto_Sans_JP'] text-[14px] font-semibold text-gray-600 mb-1">主な用途・キャリアパス</p>
                <p className="font-['Noto_Sans_JP'] text-[14px] text-gray-700">AI開発、機械学習、データ分析、Webアプリケーション開発（Django, Flask）、業務自動化など。</p>
              </div>
            </div>
          </div>
          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden">
            <div className="bg-gray-50 px-4 py-2 border-b border-gray-200">
              <p className="font-['Noto_Sans_JP'] font-bold text-[14px] text-gray-800">JavaScript</p>
              <p className="font-['Noto_Sans_JP'] text-[14px] text-gray-600 font-medium">学習難易度：中程度</p>
            </div>
            <div className="px-4 py-4 space-y-3 text-base leading-[1.8]">
              <div>
                <p className="font-['Noto_Sans_JP'] text-[14px] font-semibold text-gray-600 mb-1">特徴</p>
                <p className="font-['Noto_Sans_JP'] text-[14px] text-gray-700">Webブラウザ上で動作する唯一のプログラミング言語であり、Web開発には欠かせません。フロントエンドだけでなく、バックエンド（Node.js）でも使用可能です。</p>
              </div>
              <div>
                <p className="font-['Noto_Sans_JP'] text-[14px] font-semibold text-gray-600 mb-1">主な用途・キャリアパス</p>
                <p className="font-['Noto_Sans_JP'] text-[14px] text-gray-700">Webサイトのフロントエンド開発、Webアプリケーション開発（React, Vue.js, Angular）、バックエンド開発（Node.js）、モバイルアプリ開発など。</p>
              </div>
            </div>
          </div>
          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden">
            <div className="bg-gray-50 px-4 py-2 border-b border-gray-200">
              <p className="font-['Noto_Sans_JP'] font-bold text-[14px] text-gray-800">Ruby</p>
              <p className="font-['Noto_Sans_JP'] text-[14px] text-gray-600 font-medium">学習難易度：中程度</p>
            </div>
            <div className="px-4 py-4 space-y-3 text-base leading-[1.8]">
              <div>
                <p className="font-['Noto_Sans_JP'] text-[14px] font-semibold text-gray-600 mb-1">特徴</p>
                <p className="font-['Noto_Sans_JP'] text-[14px] text-gray-700">日本人が開発したオブジェクト指向スクリプト言語で、記述がシンプルで直感的です。WebフレームワークのRuby on Railsは、効率的なWebアプリケーション開発を可能にします。</p>
              </div>
              <div>
                <p className="font-['Noto_Sans_JP'] text-[14px] font-semibold text-gray-600 mb-1">主な用途・キャリアパス</p>
                <p className="font-['Noto_Sans_JP'] text-[14px] text-gray-700">Webアプリケーション開発（Ruby on Rails）、スタートアップ企業の開発現場など。</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]"><strong>Progate（プロゲート）</strong>: スライド形式で学べるため、プログラミングの基礎をゲーム感覚で楽しく習得できます。手を動かしながら学べる点が魅力です。</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]"><strong>ドットインストール</strong>: 3分動画でプログラミングを学べるサービスで、短時間で多くの知識をインプットしたい場合に最適です。環境構築から丁寧に解説されています。</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]"><strong>Udemy（ユーデミー）</strong>: 世界中の講師による多様なプログラミング講座が提供されており、動画形式で実践的な内容を深く学ぶことができます。セール期間を狙えばお得に受講可能です。</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]"><strong>paizaラーニング</strong>: 動画と演習問題でプログラミングを学べるサービスで、特に実践的なコーディングスキルを身につけるのに役立ちます。そのまま就職・転職活動に繋がる機能もあります。</li>
        </ul>
        <ArticleParagraph>
        ...
        <ArticleTable
          headers={['学習方法', 'メリット', 'デメリット']}
          data={[
            ['独学', '費用を抑えられる、自分のペースで学習できる、問題解決能力が身につく', 'モチベーション維持が難しい、質問できる環境がない、学習計画の立案が難しい、転職サポートがない'],
            ['プログラミングスクール', '体系的なカリキュラム、質問・サポート体制、モチベーション維持、転職サポート', '費用がかかる、学習ペースが固定される場合がある、スクール選びが重要'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout
      ...
      <ArticleBodySection id="section-7" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]"><strong>目標を明確にする</strong>: なぜエンジニアになりたいのか、どんなエンジニアになりたいのかを具体的にすることで、学習の原動力となります。</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]"><strong>学習の進捗を可視化する</strong>: 学習時間や習得したスキルを記録することで、自分の成長を実感でき、達成感につながります。</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]"><strong>アウトプットを意識する</strong>: 学んだことをブログにまとめる、SNSで発信する、簡単なツールを作成するなど、積極的にアウトプットすることで知識の定着が図れます。</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]"><strong>仲間を見つける</strong>: 同じ目標を持つ仲間と交流することで、悩みを共有したり、互いに励まし合ったりできます。</li>
          <li className="font-['Noto_Sans_JP'] text-[14px] leading-[25px]"><strong>適度な休憩と気分転換</strong>: 集中力が途切れたと感じたら、無理に学習を続けず、意識的にリフレッシュする時間を取りましょう。</li>
        </ul>
        ...
        <ArticleTable
          headers={['資格名', '概要とおすすめポイント', '難易度と位置づけ']}
          data={[
      ...
      <PointHeaderBox title="編集部より" bodyVariant="highlight">
        <div className="space-y-3">
          <p className="text-sm text-[var(--color-v2-text)]">ここまで読んでくださって、ありがとうございます。</p>
          <p className="text-sm text-[var(--color-v2-text)]">最後に、1つだけお伝えしたいことがあります。</p>
          <p className="text-sm text-[var(--color-v2-text)]">「1年後、あなたは何をしていますか?」</p>
          <p className="text-sm text-[var(--color-v2-text)]">今と同じ仕事で、同じ年収で、同じ不安を抱えていますか?</p>
          <p className="text-sm text-[var(--color-v2-text)]">それとも、エンジニアとして新しいキャリアを歩み始めていますか?</p>
          <p className="text-sm text-[var(--color-v2-text)]">答えは、今日のあなたの選択で決まります。</p>
          <p className="text-sm text-[var(--color-v2-text)]">学習を始めるのも、転職エージェントに相談するのも、全て無料でできます。</p>
          <p className="text-sm text-[var(--color-v2-text)]">失うものは何もありません。</p>
          <p className="text-sm text-[var(--color-v2-text)]">でも、行動しないことで失うのは...「可能性」という、何より大切なものです。</p>
        </div>
      </PointHeaderBox>
      ...
      {/* 今すぐ始められる3つのアクション */}
      <div className="mb-8">
        <ArticleSubHeading>今すぐ始められる3つのアクション</ArticleSubHeading>
        <div className="space-y-5">
          <div>
            <p className="font-['Noto_Sans_JP'] text-[14px] font-semibold text-gray-800 mb-1">1️⃣ まずは学習を始める</p>
            <ArticleParagraph className="mb-1">
              <strong>Progate</strong>や<strong>ドットインストール</strong>でプログラミングの基礎を無料体験
            </ArticleParagraph>
            <p className="font-['Noto_Sans_JP'] text-[14px] text-gray-600">→ 1週間で「自分にもできる」を実感できます</p>
          </div>
          <div>
            <p className="font-['Noto_Sans_JP'] text-[14px] font-semibold text-gray-800 mb-1">2️⃣ スクールの無料相談を受ける</p>
            <ArticleParagraph className="mb-1">
              <strong>転職サポート付きスクール</strong>の無料カウンセリングに参加
            </ArticleParagraph>
            <p className="font-['Noto_Sans_JP'] text-[14px] text-gray-600">→ あなたに最適な学習プランを診断してもらえます</p>
          </div>
          <div>
            <p className="font-['Noto_Sans_JP'] text-[14px] font-semibold text-gray-800 mb-1">3️⃣ 転職エージェントに相談する</p>
            <ArticleParagraph className="mb-1">
              <strong>IT業界特化エージェント</strong>に登録（完全無料）
            </ArticleParagraph>
            <p className="font-['Noto_Sans_JP'] text-[14px] text-gray-600">→ 未経験OKの求人情報をチェックできます</p>
          </div>
        </div>
        <ArticleParagraph className="mt-5 font-semibold text-gray-800">
          迷っている時間がもったいない。<br />
          まずは1つでも行動してみましょう。
        </ArticleParagraph>
      </div>
      ...
      {/* セクション8 */}
      <ArticleBodySection id="section-8" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        <ArticleSectionHeading>
          8. まとめ
        </ArticleSectionHeading>
        <ArticleParagraph>
        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          <ArticleSubHeading className="mb-3">免責事項</ArticleSubHeading>
