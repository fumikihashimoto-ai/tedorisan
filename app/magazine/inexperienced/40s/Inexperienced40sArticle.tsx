  ...
  return (
    <article className="pb-20">
      ...
      <ArticleBodySection id="section-1" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        ...
        <ArticleTable
          headers={['業界名', '未経験者が歓迎される理由', '主な職種例']}
          data={[
            ['介護業界', '高齢化社会の進展に伴い、常に人材が不足しており、人柄やコミュニケーション能力が重視されます。資格取得支援制度も充実しています。', '介護職員、生活相談員、ケアマネジャー（経験後に資格取得）'],
            ['IT業界（特にインフラ・サポート系）', 'デジタル化の加速により需要が拡大。論理的思考力や学習意欲があれば、未経験からでもインフラエンジニアやヘルプデスクなどで活躍できます。', 'インフラエンジニア、ヘルプデスク、ITサポート、Web開発アシスタント'],
            ['建設業界', '若年層の入職者が少なく、技術やノウハウの継承が課題です。真面目さや体力、安全意識があれば、現場作業員や施工管理補助などから始められます。', '現場作業員、施工管理アシスタント、重機オペレーター（資格取得後）'],
            ['物流業界', 'ECサイトの普及により物流量が増加し、倉庫作業員や配送ドライバーの需要が高まっています。チームワークや正確性が求められます。', '倉庫作業員、配送ドライバー（要免許）、物流管理補助'],
            ['清掃・ビルメンテナンス業界', '景気に左右されにくく、安定した需要があります。丁寧さや責任感があれば、未経験からでも始めやすい職種です。', '清掃スタッフ、設備管理員、警備員（兼務の場合あり）'],
          ]}
          headerAlign="left"
          dataAlign="left"
        ...
        <ArticleTable
          headers={['活かせる経験・スキル', '隠れた未経験職種例', '活かされ方']}
          data={[
            ['営業・販売経験（コミュニケーション、提案力）', '法人営業、キャリアアドバイザー、広報・PR、カスタマーサクセス', '顧客の課題ヒアリング、ソリューション提案、信頼関係構築、企業イメージ向上'],
            ['事務・経理経験（正確性、管理能力、PCスキル）', '人事、総務、Webサイト運用補助、データ入力・分析補助', '勤怠管理、福利厚生制度の運用、情報整理、効率的な業務遂行'],
            ['サービス業経験（ホスピタリティ、臨機応変な対応力）', 'ホテル・旅館のフロント、受付、秘書、イベント運営スタッフ', '顧客満足度向上、スムーズな対応、細やかな気配り'],
            ['製造業・技術職経験（論理的思考、品質管理、改善提案）', '品質管理補助、生産管理補助、ITテストエンジニア、技術営業', '製品・サービスの品質向上、効率的な生産計画、技術的な説明能力'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
        ...
        <ArticleTable
          headers={['スキル分野', '具体的なスキル・資格例', '開ける職種例']}
          data={[
            ['IT・Web系スキル', 'プログラミング言語（Python, JavaScriptなど）、Webデザイン、デジタルマーケティング、データサイエンス基礎、ITパスポート', 'Webエンジニア、Webデザイナー、デジタルマーケター、データアナリスト補助、ITサポート'],
            ['介護・医療系スキル', '介護職員初任者研修、介護福祉士、医療事務、登録販売者', '介護職員、医療事務スタッフ、ドラッグストア販売員'],
            ['ビジネス系スキル', '簿記2級、社会保険労務士（補助）、宅地建物取引士、FP技能士', '経理事務、人事・労務補助、不動産営業・事務、金融アドバイザー補助'],
            ['語学スキル', 'TOEIC高得点、ビジネス英会話、中国語・韓国語など', 'インバウンド向けサービス業、海外事業部門補助、翻訳・通訳補助'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
      ...
      <ArticleBodySection id="section-2" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        ...
        <ArticleSubHeading className="mt-5 mb-2">2.3.1 想定される質問とその回答例</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          40代未経験での転職面接では、これまでの経験と未経験分野への適応能力について深く問われる傾向があります。よくある質問とその回答例を参考に、あなた自身の言葉で準備を進めましょう。
        </ArticleParagraph>

        <ArticleTable
          headers={['想定される質問', '回答のポイント']}
          data={[
            ['なぜこの業界・職種を未経験で志望するのですか？', 'これまでの経験で得た気づきや、将来のキャリアプランと結びつけて具体的に説明します。単なる憧れではなく、入念な情報収集と自己分析に基づいた論理的な理由を述べましょう。その業界・職種でなければならない理由を明確にすることが重要です。'],
            ['40代で未経験からの転職は、体力的に大変だと思いますが大丈夫ですか？', '健康面での不安がないこと、そして新しい環境への適応力や学習意欲を強調します。過去に困難を乗り越えた経験や、日頃から体調管理に気を使っていることを具体的に伝え、年齢がハンディキャップにならないことをアピールします。'],
            ['これまでの経験をどのように活かせるとお考えですか？', '前職で培ったポータブルスキル（課題解決能力、コミュニケーション能力、マネジメント能力など）を具体的に挙げ、未経験職種でどのように応用できるかを説明します。自己分析で洗い出した強みをここで存分にアピールしましょう。'],
            ['当社で働く上で、どのような貢献ができると思いますか？', '企業の事業内容や課題を理解した上で、自身の強みやスキルがどのように貢献できるかを具体的に提案します。未経験であっても、入社後の成長意欲や、これまでの社会人経験で培った視点から貢献できる点を述べることが重要です。'],
            ['未経験の業務に対して、どのように学習し、キャッチアップしていきますか？', '具体的な学習計画（資格取得、研修受講、自主学習など）を提示し、積極的な学習意欲と行動力を示します。OJTだけでなく、自ら進んで知識やスキルを習得していく姿勢をアピールしましょう。'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
      ...
      <ArticleBodySection id="section-3" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        ...
        <ArticleTable
          headers={['情報収集の項目', '具体的な内容と確認方法']}
          data={[
            ['企業文化・社風', '企業のウェブサイトやSNS、採用ブログなどで発信されているメッセージから、企業が大切にしている価値観を読み取ります。可能であれば、企業説明会やインターンシップ、カジュアル面談などを通じて、実際に働く社員の雰囲気を感じ取ることが有効です。'],
            ['具体的な業務内容と期待値', '求人票の業務内容だけでなく、面接時に「入社後、具体的にどのような業務からスタートするか」「どのようなスキルアップを期待されているか」などを具体的に質問しましょう。未経験の場合、研修制度やOJTの有無も確認ポイントです。'],
            ['職場の人間関係・チーム体制', '配属予定の部署の人数構成や、チーム内のコミュニケーションスタイルなどを確認します。面接官や採用担当者との会話の中で、社内の人間関係に関するヒントを得ることもできます。企業によっては、現場社員との交流機会を設けてくれる場合もあります。'],
            ['残業時間の実態', '求人票の残業時間表示だけでなく、実際の残業時間や、残業代の支給状況について確認します。口コミサイトや転職エージェントを通じて、現場のリアルな情報を得ることも有効です。'],
            ['キャリアパス・評価制度', '未経験からのスタートであっても、将来的にどのようなキャリアアップが可能なのか、評価制度はどのように運用されているのかを確認しましょう。自身の長期的なキャリアプランと合致しているかを見極める重要なポイントです。'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
      ...
      <ArticleBodySection id="section-4" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        ...
        <ArticleTable
          headers={['項目', '詳細', '40代未経験転職における重要性']}
          data={[
            ['ミドル層・ハイクラス求人の実績', '40代の転職成功事例や、ミドル層向けの求人案件を豊富に扱っているか。', '年齢層に合わせた求人開拓力と、企業への交渉力が期待できるため。'],
            ['未経験転職支援の実績', '異業種・異職種への転職支援に長けているか。', 'あなたのこれまでの経験を未経験分野で活かすための「見せ方」や「アピール方法」を熟知しているため。'],
            ['非公開求人の質と量', '一般には公開されていない、企業が求める特定のスキルや人物像に合致する求人をどれだけ持っているか。', '市場に少ない未経験歓迎の求人や、あなたのポテンシャルを評価してくれる企業と出会える可能性が高まるため。'],
            ['専門分野への知見', 'あなたが希望する業界や職種について、深い知識を持っているか。', '業界の動向や企業文化を理解しているため、ミスマッチを防ぎ、的確なアドバイスを受けられるため。'],
            ['キャリアコンサルティングの質', '単なる求人紹介だけでなく、あなたの強みやキャリアプランを一緒に考えてくれるか。', '自己分析の深化を促し、未経験からの転職におけるあなたの市場価値を最大化してくれるため。'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
