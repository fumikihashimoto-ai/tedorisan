  ...
  return (
    <article className="pb-20">
      ...
      <ArticleBodySection id="section-1" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        ...
        <ArticleTable
          headers={['有利な点', '企業側のメリット']}
          data={[
            ['若さとポテンシャル', '新しい知識・スキルへの高い吸収力、長期的な育成を見込める'],
            ['柔軟性と適応力', '新しい環境や企業文化への順応性、変化への対応力'],
            ['第二新卒としての評価', '基本的なビジネスマナーと社会人基礎が備わっている、前職の文化に染まりすぎていない'],
            ['未経験歓迎求人の多さ', '意欲や人柄を重視する企業との出会いが多い、多様な業界・職種への挑戦機会'],
          ]}
          headerAlign="left"
          dataAlign="left"
        ...
        <ArticleSubHeading className="mt-5 mb-2">1.2.1 不安1：本当に未経験でも採用されるのか</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2 font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
          ...
          <li>自己分析を徹底し、自身の強みや仕事への熱意を言語化する。</li>
          <li>応募先の企業や職種について深く研究し、入社後の具体的なビジョンを提示する。</li>
          <li>未経験歓迎の求人に特化して応募する。</li>
        </ul>

        <ArticleSubHeading className="mt-5 mb-2">1.2.2 不安2：給与が下がってしまうのではないか</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2 font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
          ...
          <li>目先の給与だけでなく、将来的なキャリアパスや昇給の見込みも考慮して企業を選ぶ。</li>
          <li>自身のスキルや経験が活かせる部分がないか、異業種であっても共通点を見つけアピールする。</li>
        </ul>

        <ArticleSubHeading className="mt-5 mb-2">1.2.3 不安3：新しい職場の人間関係に馴染めるか</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2 font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
          ...
          <li>面接時に職場の雰囲気やチーム体制について質問する。</li>
          <li>入社後は積極的にコミュニケーションを取り、学ぶ姿勢を示す。</li>
          <li>もし可能であれば、企業説明会やインターンシップに参加して、事前に社員と交流する機会を持つ。</li>
        </ul>

        <ArticleSubHeading className="mt-5 mb-2">1.2.4 不安4：転職活動がなかなかうまくいかない</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2 font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
          ...
          <li>応募書類の内容や面接での受け答えを客観的に見直し、改善点を探す。</li>
          <li>転職エージェントを利用し、プロの視点からアドバイスをもらう。</li>
          <li>複数の企業に応募し、選択肢を広げる。</li>
          <li>一時的な結果に一喜一憂せず、長期的な視点で活動を続ける。</li>
        </ul>
        <ArticleParagraph className="mb-4">
      ...
      <ArticleBodySection id="section-2" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        ...
        <ArticleSubHeading className="mt-5 mb-2">2.1.1 自己分析に役立つフレームワーク</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          自己分析にはいくつかの有効なフレームワークがあります。これらを活用することで、客観的に自分を見つめ直すことができます。
        </ArticleParagraph>

        <ArticleTable
          headers={['フレームワーク', '概要', '得られる視点']}
          data={[
            ['SWOT分析', '自身の強み（Strengths）、弱み（Weaknesses）、機会（Opportunities）、脅威（Threats）を洗い出す分析手法です。外部環境と内部環境の両面から自分を評価します。', '自身の内部要因（強み・弱み）と外部要因（機会・脅威）を組み合わせることで、キャリア戦略の方向性が見えてきます。'],
            ['Will-Can-Must', '「Will（やりたいこと）」「Can（できること）」「Must（すべきこと/求められていること）」の3つの視点から自己を深掘りします。', '自身の情熱、スキル、そして社会や企業からの期待をバランス良く把握し、キャリアの軸を明確にするのに役立ちます。'],
            ['モチベーションの源泉', 'これまでの人生で「楽しかったこと」「達成感を感じたこと」「夢中になったこと」などを具体的に振り返り、どのような状況でモチベーションが上がるのかを特定します。', '仕事選びにおいて、自身のやる気を引き出す要素や、長く続けられる仕事のヒントを見つけることができます。'],
            ['価値観の明確化', '仕事を通じて「何を大切にしたいか」（例：成長、安定、貢献、自由、人間関係など）を考えます。', '企業文化や働き方とのミスマッチを防ぎ、長期的な満足感に繋がる職場を選ぶための基準となります。'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
        ...
        <ArticleSubHeading className="mt-5 mb-2">2.2.1 効果的な業界・職種研究の方法</ArticleSubHeading>
        <ul className="list-disc pl-6 mb-4 space-y-2 font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
          <li>
        ...
        <ArticleSubHeading className="mt-5 mb-2">2.3.1 未経験から挑戦しやすい職種とキャリアパス</ArticleSubHeading>
        <ArticleTable
          headers={['職種例', '仕事内容の概要', 'キャリアパスの例', '求められる資質・スキル（未経験の場合）']}
          data={[
            ['ITエンジニア（プログラマー、Webエンジニアなど）', 'システム開発、Webサイト・アプリ制作、インフラ構築・運用など。', 'プログラマー → システムエンジニア → プロジェクトマネージャー/ITコンサルタント、あるいはスペシャリストとして技術を深める。', '論理的思考力、学習意欲、問題解決能力、情報収集力。未経験者向け研修制度のある企業も多い。'],
            ['営業職', '自社の商品やサービスを顧客に提案し、契約を獲得する。法人営業、個人営業など。', '営業担当 → 営業リーダー → マネージャー、あるいはマーケティング、企画職への転身。', 'コミュニケーション能力、目標達成意欲、傾聴力、課題解決能力、ポジティブ思考。'],
            ['事務職（一般事務、営業事務など）', 'データ入力、資料作成、電話応対、来客対応、経理補助など、多岐にわたるサポート業務。', '一般事務 → 専門事務（経理、人事など） → チームリーダー、あるいは秘書、広報など。', 'PCスキル（Word, Excel）、正確性、丁寧さ、コミュニケーション能力、マルチタスク処理能力。'],
            ['Webマーケター', 'Webサイトのアクセス解析、SEO対策、SNS運用、広告運用など、Web上での集客や売上向上を目的とした戦略立案・実行。', 'Web広告運用担当 → SEOスペシャリスト → Webマーケティング戦略担当 → マネージャー。', '情報感度、分析力、論理的思考力、トレンドへの関心、PDCAを回す力。'],
            ['介護職・医療事務', '介護施設での身体介助・生活援助、病院やクリニックでの受付・会計・レセプト業務など。', '介護士 → ケアマネージャー、医療事務 → 医療秘書、管理職。', 'コミュニケーション能力、協調性、責任感、体力（介護職）、細やかな気配り。'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
      ...
      <ArticleBodySection id="section-3" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.2.1 履歴書のポイント</ArticleSubHeading>
        <ul className="list-disc pl-6 mb-4 space-y-2 font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
          <li>
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.2.2 職務経歴書のポイント</ArticleSubHeading>
        <ul className="list-disc pl-6 mb-4 space-y-2 font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
          <li>
