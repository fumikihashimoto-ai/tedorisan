  ...
  return (
    <article className="pb-20">
      ...
      <ArticleBodySection id="section-1" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        <ArticleSectionHeading>1. 臨床検査技師の平均年収とは</ArticleSectionHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading>1.1 年代別の臨床検査技師の年収</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading>1.2 勤務先別の臨床検査技師の年収</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          臨床検査技師の年収は、働く施設の種類によっても大きく異なります。主な勤務先としては、病院・クリニック、検査センター、企業などが挙げられ、それぞれの特性が年収に影響を与えます。
        </ArticleParagraph>

        <ArticleSubHeading className="mt-5 mb-2">1.2.1 病院・クリニックの臨床検査技師の年収</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">1.2.2 検査センターの臨床検査技師の年収</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">1.2.3 企業の臨床検査技師の年収</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading>1.3 地域別の臨床検査技師の年収</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
      ...
      <ArticleBodySection id="section-2" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        <ArticleSectionHeading>2. 臨床検査技師の年収が決まる要因</ArticleSectionHeading>
        <ArticleParagraph className="mb-4">
          臨床検査技師の年収は、様々な要因によって変動します。ここでは、年収を決定づける主な要素について詳しく解説します。
        </ArticleParagraph>

        <ArticleSubHeading>2.1 経験年数とスキルが臨床検査技師の年収に与える影響</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          臨床検査技師の年収は、
        ...
        <ArticleTable
          ...
          data={[
            ...
            ['25～29歳', '428万円'],
            ['30～34歳', '476万円'],
            ['35～39歳', '約482.4万円～589.3万円'],
            ['40～44歳', '約491.9万円～546.4万円'],
            ['45～49歳', '約548.9万円～654.6万円'],
            ['50～54歳', '約587.2万円～923.59万円'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
        ...
        <ArticleSubHeading>2.2 保有資格と認定が臨床検査技師の年収に与える影響</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          臨床検査技師が
        ...
        <ArticleSubHeading>2.3 役職と責任が臨床検査技師の年収に与える影響</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          臨床検査技師が
        ...
        <ArticleSubHeading>2.4 勤務形態と残業代が臨床検査技師の年収に与える影響</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          臨床検査技師の年収は、
      ...
      <ArticleBodySection id="section-3" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        <ArticleSectionHeading>3. 臨床検査技師が年収を上げる具体的な方法</ArticleSectionHeading>
        <ArticleParagraph className="mb-4">
          臨床検査技師として年収を向上させるためには、自身の専門性を高め、市場価値を高めることが重要です。ここでは、具体的な年収アップの方法について詳しく解説します。
        </ArticleParagraph>

        <ArticleSubHeading>3.1 専門性を高める資格取得</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.1.1 認定臨床検査技師の取得</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.1.2 細胞検査士の取得</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.1.3 超音波検査士の取得</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading>3.2 転職で臨床検査技師の年収アップを狙う</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.2.1 高年収の求人を見つけるポイント</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.2.2 転職を成功させるための準備</ArticleSubHeading>
        <ul className="list-disc pl-6 mb-4 space-y-2 font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
          <li>
        ...
        <ArticleSubHeading>3.3 管理職へのキャリアアップ</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading>3.4 副業や兼業で収入を増やす</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
