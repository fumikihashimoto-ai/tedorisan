  ...
  return (
    <article className="pb-20">
      ...
      <ArticleBodySection id="section-1" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        ...
        <ArticleSubHeading>1.2 職種別の年収比較</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          建設業と一口に言っても、その職種は多岐にわたり、それぞれの専門性や役割に応じて年収水準も大きく異なります。特に専門性の高い技術職や管理職は高年収が期待できる傾向にあります。
        </ArticleParagraph>

        <ArticleTable
          headers={['職種', '平均年収の目安', '備考']}
          data={[
            ['一級建築士', '約640万円～700万円', '扱う建築物の規模が大きく、専門性が高い'],
            ['技術士', '約670万円', '特定の専門分野における高度な技術力を有する'],
            ['建築施工管理技士（1級）', '約460万円～750万円', '工事全体の管理・監督を行う。資格の有無が大きく影響'],
            ['土木施工管理技士', '約400万円～600万円', '土木工事の施工管理を担う。1級取得で高年収が期待できる'],
            ['電気工', '約450万円', '電気設備の設置・配線工事などを行う'],
            ['測量技術者', '約450万円', '建設現場の測量や調査を担当'],
            ['大工', '約350万円～450万円', '建物の骨組みや内外装の木工事を行う'],
            ['鉄筋工', '約400万円', '建物の基礎となる鉄筋の組み立てを行う'],
            ['掘削作業主任者・発破技士', '約620万円', '専門的な作業を伴うため、高年収が期待できる'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
        ...
        <ArticleSubHeading>1.3 年収に影響を与える要因</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          建設業で年収を決定する要因は多岐にわたりますが、特に以下の要素が大きく影響します。
        </ArticleParagraph>

        <ArticleSubHeading className="mt-5 mb-2">1.3.1 経験年数とスキル</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          建設業界では、
        ...
        <ArticleSubHeading className="mt-5 mb-2">1.3.2 企業の規模と地域</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          年収は、所属する
        ...
        <ArticleSubHeading className="mt-5 mb-2">1.3.3 資格の有無</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          建設業において、
      ...
      <ArticleBodySection id="section-2" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        <ArticleSectionHeading>2. 年収1000万円を実現するキャリアパス</ArticleSectionHeading>
        <ArticleParagraph className="mb-4">
          建設業界で年収1000万円という目標は、決して夢物語ではありません。適切なキャリアパスを選択し、戦略的にスキルと経験を積み重ねることで、この高収入を実現することは十分に可能です。
        </ArticleParagraph>

        <ArticleSubHeading>2.1 高年収が期待できる職種</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleTable
          headers={['職種名', '業務内容の概要', '高年収を期待できる理由']}
          data={[
            ['施工管理', '建築物や土木構造物の建設現場において、工程、品質、安全、原価の管理を行う。', 'プロジェクト全体の責任を負い、多額の予算と多数の協力会社を動かす重要なポジション。大規模なゼネコンや専門性の高いサブコンでの経験が評価される。'],
            ['設計・デザイン', '建築設計、都市計画、ランドスケープデザインなど、建設物の企画から具体的な図面作成までを担当。', '創造性、技術力、そして法規やコストを考慮した総合的な提案力が求められる。BIM/CIMなどの最新技術を使いこなせる人材も重宝される。'],
            ['コンサルタント・PM', '建設プロジェクトの企画立案、事業性評価、発注者支援、プロジェクトマネジメントなどを行う。', '高度な専門知識と豊富な経験に基づき、プロジェクトの成功に不可欠な戦略的判断を下す。国内外のインフラプロジェクトや大規模再開発で高い報酬が設定されている。'],
            ['技術開発・研究', '新素材の開発、新工法の研究、建設DX技術（AI、IoT、ロボット、BIM/CIMなど）の研究開発を行う。', '最先端の技術を追求し、業界全体の生産性向上や新たな価値創造に貢献。大手ゼネコンの研究開発部門で高収入が期待できる。'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
        ...
        <ArticleSubHeading>2.2 キャリアアップのためのステップ</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading>2.3 未経験から高年収を目指す方法</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
      ...
      <ArticleBodySection id="section-3" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        <ArticleSectionHeading>3. 年収アップに直結する資格とスキル</ArticleSectionHeading>
        <ArticleParagraph className="mb-4">
          建設業界で年収1000万円を目指す上で、
        ...
        <ArticleSubHeading>3.1 取得すべき国家資格</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          建設業において、特定の業務を行うためには国家資格が必須となる場合が多く、これらの資格は年収に直結する重要な要素です。特に1級の資格は、大規模なプロジェクトの責任者を務めるために必要とされ、その分高い評価と報酬につながります。
        </ArticleParagraph>

        <ArticleTable
          headers={['資格名', '概要と年収への影響', '想定される職種']}
          data={[
            ['1級施工管理技士', '建設現場における施工計画、工程管理、品質管理、安全管理などを統括。1級は大規模な工事の主任技術者や監理技術者になれるため、年収1000万円を目指す上で必須級の資格。', '施工管理者、プロジェクトマネージャー'],
            ['1級建築士', '建築物の設計・工事監理を行う国家資格。1級は大規模な建築物や複雑な構造の建築物の設計が可能。専門性が非常に高く、設計事務所の経営や大手建設会社の設計部門で高収入が期待できる。', '建築設計者、設計監理者'],
            ['技術士（建設部門）', '科学技術に関する高度な専門知識と応用能力を持つことを証明する国家資格。建設コンサルタントや大手建設会社の技術開発部門などで専門家としての高い評価と報酬を得られる。', '建設コンサルタント、研究開発者'],
            ['宅地建物取引士', '不動産取引に関する専門知識を持つ国家資格。建設業の中でも、不動産開発や宅地造成などを手掛ける企業で、土地の仕入れや販売において重宝され、年収アップに貢献。', '不動産開発担当者、用地仕入れ担当者'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
        ...
        <ArticleSubHeading>3.2 実務経験と専門スキルの重要性</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading>3.3 マネジメント能力の向上</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
      ...
      <ArticleBodySection id="section-4" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        <ArticleSectionHeading>4. 高収入を叶える転職戦略</ArticleSectionHeading>
        <ArticleParagraph className="mb-4">
          建設業界で年収1000万円という高収入を実現するためには、戦略的な転職活動が不可欠です。現在の市場動向を正確に把握し、自身の強みを最大限に活かせる企業や職種を見極めることが成功への鍵となります。
        </ArticleParagraph>

        <ArticleSubHeading>4.1 大手企業と中小企業の選択肢</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleTable
          headers={['比較項目', '大手企業（ゼネコンなど）', '中小企業（専門工事会社など）']}
          data={[
            ['プロジェクト規模', '大規模なインフラ、都市開発、ランドマーク建築など', '専門工事、地域密着型案件、小規模から中規模建築など'],
            ['年収水準', '全体的に高水準、特に管理職や専門職では1000万円超も可能', '企業や専門性によるが、特定の分野では高水準も可能'],
            ['キャリアパス', '組織的なキャリアアップ、多様な部門での経験、海外勤務の可能性', '早期の裁量権、多様な業務経験、専門技術の深化、経営層への近さ'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
        ...
        <ArticleSubHeading>4.2 転職市場の動向とチャンス</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          建設業界の転職市場は、現在、
        ...
        <ArticleSubHeading>4.3 効果的な転職活動の進め方</ArticleSubHeading>
        <ul className="list-disc pl-6 mb-4 space-y-2 font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
          <li>
