  ...
  return (
    <article className="pb-20">
      ...
      <ArticleBodySection id="section-1" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        <ArticleSectionHeading>1. 保育士の年収 その実態をまずは知ろう</ArticleSectionHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading>1.1 全国平均や地域別の保育士 年収</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading>1.2 経験年数や年齢別の保育士 年収</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleTable
          headers={['経験年数', '年齢層の目安', '平均年収']}
          data={[
            ['1～4年目', '20代前半', '約347万円'],
            ['5～9年目', '20代後半', '約379万円'],
            ['10～14年目', '30代前半', '約398万円'],
            ['15年目以上', '30代後半～', '約463万円'],
          ]}
          headerAlign="left"
          dataAlign="left"
        ...
        <ArticleSubHeading>1.3 施設形態別の保育士 年収 公立と私立の違い</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
      ...
      <ArticleBodySection id="section-2" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        <ArticleSectionHeading>2. 今すぐできる保育士の給料アップ術</ArticleSectionHeading>

        <ArticleSubHeading>2.1 資格手当や役職手当で年収アップを目指す</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          保育士の年収を上げるための第一歩として、
        ...
        <ArticleSubHeading className="mt-5 mb-2">2.1.1 専門性を高める資格手当</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">2.1.2 キャリアアップ研修と新たな役職</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading>2.2 残業代や処遇改善手当を最大限に活用する</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          日々の業務で発生する残業代や、国からの補助金である処遇改善手当を正しく理解し、最大限に活用することも年収アップには不可欠です。
        </ArticleParagraph>

        <ArticleSubHeading className="mt-5 mb-2">2.2.1 適正な残業代の請求</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">2.2.2 処遇改善等加算の理解と活用</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          「処遇改善等加算」は、保育士の給与改善を目的として国が設けている補助金制度です。この加算には主に以下の3種類があり、それぞれ対象者や加算額が異なります。
        </ArticleParagraph>

        <ArticleTable
          headers={['加算の種類', '対象者', '加算額の目安', '備考']}
          data={[
            ['処遇改善等加算Ⅰ', '保育施設に勤務する職員全般（勤続年数やキャリアアップを条件とする場合あり）', '月額約12,000円～38,000円程度', '施設が賃金改善計画を策定し、実績報告を行うことで加算される。'],
            ['処遇改善等加算Ⅱ', '副主任保育士、専門リーダー、職務分野別リーダーなどの中堅・若手職員', '月額約5,000円～40,000円程度', 'キャリアアップ研修の修了と、特定の役職への発令が条件となる。'],
            ['処遇改善等加算Ⅲ', '保育施設に勤務する全ての職員', '月額約9,000円程度（収入の約3%換算）', '2022年2月から実施された制度で、賃上げ効果を継続させる目的がある。'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
        ...
        <ArticleSubHeading>2.3 副業で収入の柱を増やす方法</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          本業の収入アップと並行して、
        ...
        <ArticleSubHeading className="mt-5 mb-2">2.3.1 副業の可否と注意点</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">2.3.2 保育士におすすめの副業</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
      ...
      <ArticleBodySection id="section-3" className="scroll-mt-6" contentLayout={CONTENT_LAYOUT}>
        <ArticleSectionHeading>3. 賢い転職で「保育士 年収」を大幅アップさせる</ArticleSectionHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading>3.1 高年収が期待できる保育施設の選び方</ArticleSubHeading>

        <ArticleSubHeading className="mt-5 mb-2">3.1.1 公立と私立、高年収が期待できるのは？</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          一般的に、
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.1.2 特殊な施設形態で年収アップ</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.1.3 「処遇改善手当」を最大限に活用する施設の選び方</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleTable
          headers={['処遇改善加算の種類（令和7年度以降）', '主な改善内容']}
          data={[
            ['区分①「基礎分」', '経験に応じた昇給の仕組み整備や職場環境の改善に関する加算'],
            ['区分②「賃金改善分」', '職員の賃金改善に関する加算'],
            ['区分③「質の向上分」', '職員の専門性の向上に関する加算'],
          ]}
          headerAlign="left"
          dataAlign="left"
          contentLayout={CONTENT_LAYOUT}
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.1.4 福利厚生やキャリアパスの充実度</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading>3.2 転職活動を成功させるためのポイント</ArticleSubHeading>

        <ArticleSubHeading className="mt-5 mb-2">3.2.1 自己分析と希望条件の明確化</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.2.2 情報収集と求人選びのコツ</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.2.3 応募書類の作成と面接対策</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.3.1 転職エージェントを利用するメリット</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
          転職エージェントは、非公開求人を含む豊富な求人情報を提供してくれるだけでなく、以下のようなメリットがあります。
        </ArticleParagraph>
        <ul className="list-disc pl-6 mb-4 space-y-2 font-['Noto_Sans_JP'] text-[14px] leading-[25px]">
          <li>キャリアアドバイザーによる丁寧なヒアリングと、希望に合った求人の紹介</li>
          <li>履歴書・職務経歴書の添削、面接対策などのサポート</li>
          <li>給与交渉や入社日の調整など、企業との間に立ってくれる</li>
          <li>業界に特化した情報や、職場の雰囲気などのリアルな情報提供</li>
          <li>処遇改善手当が支給される職場など、条件に合った求人を見つけやすい</li>
        </ul>

        <ArticleSubHeading className="mt-5 mb-2">3.3.2 複数のエージェントを比較検討する</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
        ...
        <ArticleSubHeading className="mt-5 mb-2">3.3.3 アドバイザーとの連携で成功率アップ</ArticleSubHeading>
        <ArticleParagraph className="mb-4">
